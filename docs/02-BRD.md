...
**Rekapitulasi (v1.2):** 51 FR. Fase 1a memuat **38 FR**; Fase 1b memuat **13 FR** (FR-04, FR-05, FR-06, FR-13, FR-14, FR-15, FR-30, FR-32, FR-33, FR-34, FR-39, FR-40, FR-50). FR-49 berpindah dari Fase 1b ke Fase 1a, kecuali bagian `FAQPage` yang mengikuti FR-32 di Fase 1b. **FR-51 ditambahkan pada v1.2** atas keputusan CEO 8 September 2026 (KD-05, `00b-ceo-decisions.md`); ia tidak berasal dari kebutuhan awal mana pun, sehingga tidak menelusur ke user story yang sudah ada.
