...
| Status | **Draft for Approval** (revisi v1.6 — menutup FR-52 dan menetapkan lembar "Product" sebagai satu-satunya sumber produk, sesuai KD-09) |
...
| 1.2 | 8 September 2026 | Business Analyst | Menambahkan FR-51 (lacak pesanan mandiri) atas keputusan CEO KD-05, kemudian diperluas KD-06 (pencatatan baris buku order otomatis). Baris ini **dituliskan mundur pada v1.5**: perubahannya sudah masuk dokumen sejak 8 September 2026 tetapi tidak pernah tercatat di tabel ini |
| 1.3 | 8 September 2026 | Business Analyst | Menambahkan FR-52 (Katalog Kopi 100 gram) atas keputusan CEO KD-07, sekaligus membatasi jangkauan BR-09 menjadi lini 200 gram saja. **Dituliskan mundur pada v1.5** |
| 1.4 | 8 September 2026 | Business Analyst | Menambahkan FR-53 (pengelolaan katalog lewat Google Sheet) atas keputusan CEO KD-08; sejak itu angka pada BR-09, BR-14, dan BR-15 dipelihara owner lewat spreadsheet sementara aturannya tetap di BRD. **Dituliskan mundur pada v1.5** |
| **1.5** | **9 September 2026** | **Business Analyst** | **Menyelaraskan seluruh angka harga dengan lembar "Product" pada `assets/brand/Kopi from heart.xlsx`: harga single origin naik, kemasan mini 100 gr baru, biji kedelapan Sindoro, houseblend menjadi dua ukuran kemasan dengan harga tersimpan masing-masing (KD-02 revisi kedua). Mencatat revisi NFR-03 dan NFR-04 oleh KD-04 yang belum pernah masuk BRD. Merapikan versi dokumen yang tertinggal di 1.1 padahal isinya sudah v1.4** |
| **1.6** | **9 September 2026** | **Business Analyst** | **Mencabut FR-52 (Katalog Kopi 100 gram) atas keputusan CEO KD-09: seluruh produk situs wajib berasal dari satu sumber, lembar "Product" pada `assets/brand/Kopi from heart.xlsx`, dan lini poster tidak ada di sana. Katalog menjadi 11 produk dan 41 varian jual, tanpa lini kedua. Kemasan mini 100 gr pada single origin TIDAK ikut dicabut** |

**Rincian perubahan v1.6** — setiap baris menyebut lokasi yang disunting dan alasannya.

| # | Lokasi yang disunting | Perubahan | Alasan |
|---|---|---|---|
| F-01 | FR-52, FR-01, FR-53, BR-09, US-02, Bagian 5.1, Bagian 12, BA-05, glosarium | **FR-52 dicabut.** Lini "Katalog Kopi 100 gram" dihapus seluruhnya dari katalog, dari data, dan dari sheet owner. Seluruh kalimat "dua lini berdampingan" dihapus bersamanya | KD-09, 9 September 2026. Lini itu tidak ada di lembar "Product", dan lembar itu kini satu-satunya sumber produk |
| F-02 | BR-09 | Kalimat pengecualian "aturan ini tidak berlaku pada lini Katalog Kopi 100 gram" dihapus. `BR-09` sekarang berlaku pada **seluruh** single origin tanpa pengecualian | Pengecualiannya lahir hanya karena ada lini kedua yang berharga per biji. Lini itu tidak ada lagi |
| F-03 | Bagian 12, Bagian 17 | Katalog dinyatakan **11 produk** dan **41 varian jual**; angka varian kembali boleh ditulis karena ia berhenti berubah setelah lini kedua dicabut, dan `check-cart.mjs` menegakkannya | E-06 menahan angka varian karena ia sedang bergerak. Sesudah KD-09 ia tetap, dan menyembunyikannya justru menyulitkan pembaca |
| F-04 | Bagian 13.1 (asumsi), FR-53 | Sheet owner cukup **dua tab** — `harga` dan `stok`. Tab `katalog100` tidak dibaca lagi dan diabaikan bila masih ada | Konsekuensi langsung F-01 pada KD-08 |

**Rincian perubahan v1.5** — setiap baris menyebut lokasi yang disunting dan alasannya.

| # | Lokasi yang disunting | Perubahan | Alasan |
|---|---|---|---|
| E-01 | BR-09, BR-10, BR-08, FR-01, FR-07, FR-11, Bagian 1, Bagian 4 (Persona A), Bagian 10.1, Bagian 11.2, Bagian 12 | Harga single origin dimutakhirkan (Signature Rp140.000 / Rp392.000, Reguler Rp125.000 / Rp352.000), kemasan mini **100 gr** ditambahkan (Signature Rp85.000, Reguler Rp70.000), dan penghematan bundling menjadi Rp28.000 dan Rp23.000 | Lembar "Product" pada `assets/brand/Kopi from heart.xlsx`, 9 September 2026. Angka lama sudah tidak dijual |
| E-02 | BR-09, FR-01, FR-07, Bagian 12, Bagian 13.1 | Single origin menjadi **delapan** biji dengan masuknya **Sindoro** (tier Reguler, Gunung Sindoro, Jawa Tengah) | Lembar "Product"; provinsi dikonfirmasi owner 9 September 2026 |
| E-03 | BR-13, BR-14, BR-15, BR-16, BR-03, FR-08, FR-21, FR-28, Bagian 12, glosarium | Houseblend menjadi **dua ukuran kemasan** — 1 kg dan 0,5 kg — masing-masing dengan harga tersimpan sendiri. Aturan "harga 0,5 kg tepat setengah harga per kg" **dicabut** di seluruh dokumen | KD-02 revisi kedua, 9 September 2026. Aturan lama akan menghasilkan test case yang salah dan mengundang kode dikembalikan ke perilaku yang keliru |
| E-04 | NFR-03, NFR-04 | Anggaran JavaScript menjadi **≤ 190 KB ter-gzip** dan Lighthouse Performance menjadi **≥ 88** | KD-04 sudah memutuskannya pada 7 September 2026 lengkap dengan buktinya, tetapi BRD tidak pernah mencatatnya. Dokumen turunan karena itu masih menguji angka yang sudah dibatalkan |
| E-05 | Bagian 0 (versi dan riwayat), Bagian 17 | Versi dokumen dinaikkan ke **1.5** dan baris 1.2, 1.3, 1.4 dituliskan mundur | Kontradiksi yang ditemukan saat revisi: kepala dokumen menulis v1.1, rekapitulasi FR menulis v1.4, dan tabel riwayat berhenti di 1.1 |
| E-06 | Bagian 12, Bagian 5.1, Bagian 5.3, US-02, BA-07, BA-08 | Hitungan katalog menjadi **11 halaman produk** (8 single origin + 3 lini houseblend). **Jumlah total varian jual tidak lagi ditulis sebagai angka** di dokumen ini | Jumlah varian sedang berubah mengikuti pemisahan dua ukuran kemasan houseblend. Angka yang ditulis hari ini akan salah minggu depan; sumber yang berlaku adalah `web/src/data/validate.ts` |
| E-07 | BR-16, BA-09 | Premis BR-16 dinyatakan gugur — Full Robusta dan BOLD 20:80 tidak lagi berharga sama | Harga baru membedakan keduanya Rp5.000 per kg |
...
| **G-08** | Rata-rata nilai order ritel | ± Rp125.000 | Rp180.000 | Rp210.000 | Total nilai order ritel dibagi jumlah order ritel per bulan. Dipantau bersama rasio pemilihan varian 3 pack dari parameter `item_variant` pada event `add_to_cart`. **Sejak KD-02, order houseblend 0,5 kg (mulai Rp95.000 sejak 9 September 2026; Rp87.500 pada penetapan awal) ikut masuk hitungan order ritel dan menarik rata-rata ke bawah; order ritel houseblend karena itu dilaporkan terpisah dari order ritel single origin agar penurunan rata-rata tidak salah dibaca sebagai kegagalan (lihat BA-05)** | Buku order owner + GA4 |
...
|---|---|---|---|
| **A — Rani, home brewer** | 27 tahun, beli 200 gr tiap 3–4 minggu, menjelajah dari HP, takut salah beli kopi seharga Rp125.000–140.000 | Katalog dengan harga terlihat, detail origin lengkap (proses, ketinggian, varietas, catatan rasa), pilihan 1 pack / 3 pack satu origin (KD-01), pilihan houseblend mulai 0,5 kg (KD-02), keranjang, pesan WhatsApp otomatis | 1 — volume trafik terbesar, konversi tercepat |
...
|---|---|---|---|---|---|
| **US-02** | Memfilter katalog berdasarkan kategori dan tier | Must | Should — Fase 1b | Katalog Fase 1 berisi 11 halaman produk dalam dua kategori. Pada ukuran ini, filter berfaset tidak memperbaiki penemuan produk secara berarti, tetapi menambah state UI, sinkronisasi URL, dan permukaan pengujian. Biayanya tidak sebanding dengan manfaatnya sebelum katalog tumbuh | Katalog Fase 1a dikelompokkan menjadi bagian Single Origin dan Houseblend dengan navigasi lompat di bagian atas (FR-03), sehingga pengunjung tetap sampai ke kelompok yang relevan dalam satu ketukan |
...
|---|---|---|---|---|---|
| **FR-01** | Halaman katalog lengkap | Sistem menampilkan seluruh produk pada satu halaman katalog: tiga lini houseblend (BOLD dengan enam rasio, BRIGHT Signature dan Reguler, Full Robusta) dan **delapan** single origin (Oelbiteno, Abmisibil, Sabin, Pyramid, Palimping, Kerinci, Pondok Baru, **Sindoro**) — total **11 halaman produk**. Sindoro ditambahkan 9 September 2026; daftar tujuh biji yang lama sudah tidak lengkap. **Tidak ada lini kedua**: sampai v1.5 halaman ini juga menayangkan lini Katalog Kopi 100 gram (FR-52), yang dicabut KD-09. Katalog dapat dicapai maksimal satu ketukan dari beranda | Must | 1a | US-01 |
...
| ID | Kebutuhan | Deskripsi | Prioritas | Fase | Asal |
|---|---|---|---|---|---|
| **FR-07** | Halaman detail single origin | Setiap single origin memiliki halaman detail yang memuat nama, daerah asal, proses, ketinggian (MASL), varietas, dan catatan rasa sejauh tersedia pada brand brief. Atribut yang belum tersedia (Oelbiteno, Pyramid, Palimping, Kerinci, dan **Sindoro**) **dikosongkan atau disembunyikan, tidak dikarang**. Untuk Sindoro, lembar "Product" hanya memberi nama; wilayah "Gunung Sindoro" dan provinsi "Jawa Tengah" **dikonfirmasi owner secara tertulis 9 September 2026**, sementara proses, ketinggian, varietas, dan catatan rasa tetap kosong sampai ia menyerahkannya. Kekosongan itu keadaan yang sah, bukan pekerjaan tertinggal | Must | 1a | US-06 |
| **FR-08** | Halaman houseblend per lini | Setiap lini houseblend memiliki halaman detail yang memuat komposisi, catatan rasa, daftar varian beserta harga **kedua ukuran kemasan — 1 kg dan 0,5 kg** (BR-13) — dan konfigurator pemesanan berkelipatan 0,5 kg (FR-21). Harga 0,5 kg ditampilkan sebagai harga kemasan yang benar-benar dijual, bukan sebagai tarif turunan dari harga per kg | Must | 1a | US-08, US-20 |
...
| **FR-11** | Pemilih varian dengan harga reaktif | Pengunjung memilih varian pada halaman detail dan harga yang ditampilkan langsung mengikuti pilihan: single origin **kemasan mini 100 gr (bila biji itu memilikinya, BR-08), 1 pack 200 gr, atau 3 pack**; houseblend salah satu rasio atau varian lini, **beserta ukuran kemasannya — 1 kg atau 0,5 kg** (BR-13). Varian terpilih terbawa ke keranjang dan ke pesan WhatsApp. **Varian 3 pack selalu berisi tiga kemasan dari origin yang sedang dibuka (BR-11, KD-01): antarmuka tidak boleh menyediakan pemilih origin campur dalam bentuk apa pun, dan salinan teks kartu maupun halaman 3 pack menonjolkan penghematan yang dihitung dari harga resmi (BR-10), bukan variasi origin** | Must | 1a | US-08, KD-01 |
...
| **FR-21** | Pemesanan houseblend dalam kelipatan 0,5 kg | Untuk houseblend, jumlah dipilih lewat konfigurator berkelipatan **0,5 kg** dengan nilai minimum **0,5 kg** (0,5 / 1 / 1,5 / 2 dan seterusnya); nilai default konfigurator adalah 1 kg dan tombol kurang nonaktif pada 0,5 kg. **Harga setiap ukuran kemasan diambil dari data, tidak pernah dihitung** (BR-13): harga 0,5 kg bukan setengah harga per kg. Subtotal baris selalu perkalian dua bilangan bulat — jumlah satuan pesan dikali harga satu satuan pesan — sehingga tidak ada aritmetika pecahan pada uang. Satuan ditulis apa adanya di keranjang dan pesan WhatsApp dengan koma desimal Indonesia ("0,5 kg", "1,5 kg"), tanpa satuan gram. **Terbuka, dan sengaja tidak dijawab di sini:** cara sebuah jumlah ≥ 1 kg disusun dari dua ukuran kemasan — apakah 1,5 kg berarti satu kemasan 1 kg ditambah satu kemasan 0,5 kg, atau tiga kemasan 0,5 kg — belum diputuskan dan sedang dikerjakan bersamaan dengan pemisahan ukuran kemasan di kode. Keduanya menghasilkan total yang berbeda. Contoh perhitungan lama pada baris ini (BOLD 60:40 5 kg = Rp1.000.000, 50:50 1,5 kg = Rp292.500) **sudah salah** dan sengaja dihapus, bukan diganti dengan tebakan. Angka yang berlaku hari ini ada di `web/src/data/` | Must | 1a | US-18, KD-02 |
...
| **FR-28** | Tabel rasio dan harga per ukuran kemasan | Seluruh rasio BOLD tampil dalam satu tabel bersama **kedua harga kemasannya**, berlaku sejak 9 September 2026 — kolom **1 kg** lalu kolom **0,5 kg**: 70:30 Rp215.000 / Rp120.000; 60:40 Rp205.000 / Rp115.000; 50:50 Rp200.000 / Rp110.000; 40:60 Rp195.000 / Rp105.000; 30:70 Rp190.000 / Rp100.000; 20:80 Rp185.000 / Rp95.000; ditambah BRIGHT Signature Rp280.000 / Rp150.000, BRIGHT Reguler Rp240.000 / Rp130.000, dan Full Robusta Rp180.000 / Rp100.000. Daftar harga per kg tunggal yang lama (Rp210.000 sampai Rp175.000) sudah tidak berlaku. Tabel terbaca di layar sempit tanpa memaksa halaman menggeser ke samping | Must | 1a | US-17 |
...
| **FR-51** | Lacak pesanan mandiri | Halaman `/lacak` menerima kode order `TAK-YYMMDD-XXXX` beserta 4 digit terakhir nomor WhatsApp pemesan, lalu menampilkan status, kurir, nomor resi, dan tanggal status terakhir diperbarui. Sumber datanya buku order milik owner, disajikan sebagai endpoint baca-saja; situs tidak menyimpan pesanan. Halaman `noindex` dan tidak masuk sitemap. Endpoint TIDAK BOLEH mengembalikan nama, nomor telepon, atau alamat pembeli, dan jawaban untuk kode salah wajib identik dengan jawaban untuk 4 digit salah. **Diperluas KD-06:** baris buku order ditulis otomatis saat pembeli menekan tombol pesan, dengan 4 digit terakhir diisi pembeli lewat kolom opsional di keranjang; pencatatan itu tidak boleh menunda maupun menggagalkan pembukaan WhatsApp | Must | 1a | KD-05, KD-06 |

| ~~**FR-52**~~ | ~~Katalog Kopi 100 gram~~ | **DICABUT 9 September 2026 oleh KD-09.** Bunyi aslinya: halaman katalog menayangkan lini kedua berisi 18 kopi dalam kemasan 100 gr, berharga per biji, seluruhnya dapat ditambahkan ke keranjang, tanpa `Tier` dan tanpa halaman produk per biji. Lini itu **tidak ada lagi** — seluruh produk situs wajib berasal dari lembar "Product" pada `assets/brand/Kopi from heart.xlsx`, dan kopi-kopi poster itu tidak ada di sana. Baris ini disimpan, bukan dihapus, supaya rujukan lama ke FR-52 mendarat pada penjelasan dan bukan pada ruang kosong. **Yang bertahan:** satuan pesan `gram-100` dan gagasan kemasan 100 gram, keduanya kini melayani kemasan mini single origin (BR-08) | ~~Must~~ **Dicabut** | — | KD-07, dicabut KD-09 |

| **FR-53** | Pengelolaan katalog oleh owner | Harga single origin per tier (termasuk kemasan mini 100 gr), harga houseblend pada kedua ukuran kemasan, dan status jual per produk dapat diubah owner lewat Google Sheet tanpa menyentuh kode, lalu diterbitkan lewat satu aksi manual atau jadwal harian. Sheet cukup **dua tab**: `harga` (24 baris) dan `stok` (11 baris); tab `katalog100` dari FR-52 tidak dibaca lagi sejak KD-09 dan diabaikan bila masih ada. Sinkronisasi wajib **gagal tertutup**: setiap tab hilang, harga hilang, harga di luar batas kewarasan, kunci tak dikenal, slug tak dikenal, atau status stok tak dikenal membatalkan penerbitan tanpa mengubah berkas apa pun, sehingga katalog terakhir yang sah tetap tayang. **Daftar produknya sendiri tidak dapat diubah dari sheet**: ia mengikuti lembar "Product" (KD-09), dan `check-cart.mjs` menggagalkan penerbitan bila katalog bertambah atau berkurang produk. Data non-angka — asal, proses, ketinggian, varietas, catatan rasa, foto — TIDAK termasuk | Must | 1a | KD-08, KD-09 |

**Rekapitulasi (v1.6):** 53 FR ditulis, **52 berlaku** — FR-52 dicabut KD-09 dan nomornya tidak dipakai ulang. Fase 1a memuat **37 FR** — turun dari 38 pada v1.5 karena FR-52 dicabut; Fase 1b memuat **13 FR** (FR-04, FR-05, FR-06, FR-13, FR-14, FR-15, FR-30, FR-32, FR-33, FR-34, FR-39, FR-40, FR-50). FR-49 berpindah dari Fase 1b ke Fase 1a, kecuali bagian `FAQPage` yang mengikuti FR-32 di Fase 1b. **FR-51 ditambahkan pada v1.2** atas keputusan CEO 8 September 2026 (KD-05, `00b-ceo-decisions.md`); ia tidak berasal dari kebutuhan awal mana pun, sehingga tidak menelusur ke user story yang sudah ada. **FR-52 ditambahkan pada v1.3** atas keputusan CEO 8 September 2026 (KD-07), yang juga membatasi jangkauan `BR-09` menjadi lini 200 gram saja. **FR-53 ditambahkan pada v1.4** atas keputusan CEO 8 September 2026 (KD-08); sejak itu angka pada `BR-09`, `BR-14`, `BR-15`, dan `BR-16` dipelihara owner lewat spreadsheet, sementara aturannya sendiri tetap di BRD. **v1.5 tidak menambah FR mana pun** — ia hanya menyelaraskan angka dan mencabut aturan harga yang sudah dibatalkan. **v1.6 juga tidak menambah FR**; ia mencabut FR-52 atas KD-09 dan mengembalikan jangkauan `BR-09` ke seluruh single origin tanpa pengecualian.
...
| **NFR-03** | Berat halaman | Total transfer halaman beranda dan katalog ≤ **600 KB** (terkompresi) pada pemuatan pertama, dengan JavaScript muat awal ≤ **190 KB ter-gzip pada rute mana pun**. Setiap gambar produk ≤ **150 KB**, disajikan dalam format modern (WebP atau AVIF) dan ukuran responsif. **Direvisi keputusan CEO KD-04, 7 September 2026** (`00b-ceo-decisions.md` D-04): target lama **150 KB** terbukti tidak dapat dicapai dengan tumpukan teknologi yang sudah dikunci — mencabut seluruh lapisan keranjang dan analitik hanya menghemat ~1,5 KB terkirim, sisanya runtime React 19 dan App Router Next 16. Plafon 190 KB diambil dari rute **terberat** (`/produk/<slug>` dan `/houseblend/<line>`, 185,4 KB), bukan dari beranda. BRD belum pernah mencatat revisi ini sampai v1.5, sehingga dokumen turunan masih menguji 150 KB | Panel Network peramban dengan cache dikosongkan; laporan ukuran bundel saat build | NF-01, KD-04 |
| **NFR-04** | Skor Lighthouse (mobile) | Performance ≥ **88**, Accessibility ≥ **95**, Best Practices ≥ **95**, SEO ≥ **95** pada beranda, katalog, satu halaman detail single origin, halaman houseblend, dan keranjang. **Direvisi keputusan CEO KD-04, 7 September 2026**: target lama Performance ≥ 90 diturunkan ke ≥ 88 pada host saat ini, karena Total Blocking Time 330 ms berakar pada beban runtime yang sama dengan NFR-03 dan bukan pada kode aplikasi. Ditinjau ulang bila situs pindah ke host yang menyajikan brotli. Ambang Accessibility, Best Practices, dan SEO **tidak** diturunkan — ketiganya sudah tercapai di angka 100 | Lighthouse versi stabil terbaru, mode mobile, tiga kali jalan dan diambil nilai median | NF-01, NF-04, KD-04 |
...
| **BR-02** | Format rupiah: awalan `Rp` tanpa spasi, pemisah ribuan berupa titik, tanpa angka desimal, tanpa spasi sebelum satuan — contoh `Rp210.000`. Harga kemasan 1 kg boleh ditulis dengan sufiks `/kg` karena ia memang harga sebuah kemasan satu kilogram, contoh `Rp215.000/kg`; harga kemasan 0,5 kg ditulis dengan konteks kemasannya, contoh `Rp120.000 / 0,5 kg`, **tidak pernah** dikonversi menjadi tarif per kilogram. Harga kemasan single origin ditulis dengan konteks jumlah pack, contoh `Rp392.000 / 3 pack` |
| **BR-03** | Tidak ada pembulatan yang dilakukan sistem. Seluruh harga resmi katalog merupakan **bilangan bulat rupiah kelipatan Rp1.000**, dan seluruh perhitungan (jumlah × harga satuan) menghasilkan bilangan bulat rupiah. Perhitungan memakai bilangan bulat rupiah, bukan pecahan desimal, agar tidak muncul selisih pembulatan. **Direvisi 9 September 2026:** versi lama menyatakan seluruh harga kelipatan **Rp5.000** dan menurunkan darinya bahwa harga 0,5 kg kelipatan Rp2.500. Keduanya sudah tidak berlaku. Kelipatan Rp5.000 dilanggar oleh harga paket 3 pack pada lembar "Product" (Signature Rp392.000, Reguler Rp352.000), dan harga 0,5 kg tidak lagi diturunkan dari harga per kg sama sekali (BR-13). Yang tersisa sebagai aturan adalah bilangan bulat rupiah dan larangan pembulatan; kelipatan Rp1.000 ditegakkan sebagai jaring pengaman salah ketik, bukan sebagai aturan harga |
...
| ID | Aturan |
|---|---|
| **BR-08** | Single origin dijual dalam kemasan **200 gr** sebagai kemasan utama, dan sejak 9 September 2026 juga dalam **kemasan mini 100 gr** untuk biji yang dicantumkan pada kolom "Single Origin - Mini Packs" lembar "Product". Kemasan mini bersifat **per biji, bukan per tier**: tujuh dari delapan biji memilikinya; **Sindoro tidak**, karena lembar itu memang melewatkannya. Menerbitkan kemasan yang tidak ada dalam rencana berarti menerima pesanan yang tidak bisa dipenuhi, sehingga ketiadaan kemasan mini pada satu biji adalah keadaan sah dan tidak boleh "dilengkapi" sendiri. Tidak ada ukuran kemasan single origin lain pada Fase 1. **Menggantikan aturan lama "tidak ada ukuran kemasan lain"** |
| **BR-09** | Harga single origin ditentukan **tier**, bukan biji: satu angka per tier per ukuran kemasan, berlaku untuk seluruh biji di tier itu. Berlaku sejak 9 September 2026 (lembar "Product"): Tier **Signature** — origin Indonesia Timur: Oelbiteno (Kupang, NTT), Abmisibil, Sabin, dan Pyramid (Papua). **Rp140.000** per 1 pack 200 gr, **Rp392.000** per 3 pack, **Rp85.000** per kemasan mini 100 gr. Tier **Reguler** — pilihan Nusantara: Palimping (Garut), Kerinci (Jambi), Pondok Baru (Bener Meriah, Aceh), dan **Sindoro** (Gunung Sindoro, Jawa Tengah — provinsi dikonfirmasi owner 9 September 2026). **Rp125.000** per 1 pack 200 gr, **Rp352.000** per 3 pack, **Rp70.000** per kemasan mini 100 gr. Sindoro tidak memiliki kemasan mini (BR-08). Harga lama — Signature Rp125.000/Rp350.000 dan Reguler Rp110.000/Rp310.000 — **sudah tidak dijual** dan tidak boleh muncul di mana pun. Sejak KD-09 aturan ini berlaku pada **seluruh** single origin tanpa pengecualian; pengecualian lama untuk lini Katalog Kopi 100 gram gugur bersama lini itu. Angkanya dipelihara owner lewat spreadsheet (FR-53, KD-08) |
| **BR-10** | Harga 3 pack adalah **harga paket**, bukan kelipatan harga satuan. Penghematan yang boleh ditampilkan dihitung dari harga resmi: Signature hemat **Rp28.000** (3 × Rp140.000 = Rp420.000 menjadi Rp392.000) dan Reguler hemat **Rp23.000** (3 × Rp125.000 = Rp375.000 menjadi Rp352.000). Nilai sebelum 9 September 2026 adalah Rp25.000 dan Rp20.000; keduanya sudah tidak berlaku. Angka penghematan tidak boleh ditulis manual di konten; harus dihitung dari data harga — justru supaya perubahan harga seperti ini tidak meninggalkan angka basi di badan halaman |
...
| ID | Aturan |
|---|---|
| **BR-13** | Houseblend dijual dalam **dua ukuran kemasan**, masing-masing dengan **harga tersimpan sendiri**: kemasan **1 kg** ("Main Packs (1kg)") dan kemasan **0,5 kg** ("Mini Packs (500gr)"), mengikuti penamaan kolom pada lembar "Product". Minimum order tetap **0,5 kg** dan kelipatannya tetap **0,5 kg**. Tidak ada kemasan houseblend di bawah 0,5 kg pada Fase 1. Harga per varian ada pada BR-14, BR-15, dan BR-16. **Harga 0,5 kg BUKAN setengah harga per kg dan tidak boleh dihitung.** Kemasan kecil membawa marginnya sendiri: BOLD 70:30 dijual Rp215.000 per kg tetapi Rp120.000 per 0,5 kg, bukan Rp107.500. Kedua angka disimpan sebagai data dan dipelihara owner pada satu permukaan sunting yang sama (FR-53, KD-08), sehingga tidak ada berkas kedua yang bisa lupa diperbarui. Dua batas kewarasan menggantikan aturan kesamaan lama, dan keduanya ditegakkan saat build (V-06): **dua kemasan 0,5 kg wajib lebih mahal daripada satu kemasan 1 kg** — kalau tidak, kemasan besar kehilangan alasan untuk ada; dan **satu kemasan 0,5 kg wajib lebih murah daripada kemasan 1 kg** — kalau tidak, halaman yang sama menawarkan kemasan lebih kecil dengan harga lebih tinggi. Kuantitas tetap disimpan sebagai bilangan bulat "jumlah setengah kilo" agar tidak ada aritmetika pecahan pada uang. (**Ditutup keputusan CEO KD-02, 7 September 2026**, menggantikan aturan lama "minimum 1 kg, kelipatan 1 kg"; **direvisi KD-02 revisi kedua, 9 September 2026**, yang mencabut aturan "harga 0,5 kg tepat setengah harga per kg" beserta seluruh tabel turunannya — Rp105.000, Rp97.500, Rp92.500, Rp87.500 dan seterusnya **tidak pernah lagi berlaku**) |
| **BR-14** | Lini BOLD wajib memilih salah satu dari enam rasio Arabica:Robusta. Setiap rasio punya dua harga tersimpan, satu per ukuran kemasan (BR-13), berlaku sejak 9 September 2026 — **1 kg / 0,5 kg**: 70:30 Rp215.000 / Rp120.000; 60:40 Rp205.000 / Rp115.000; 50:50 Rp200.000 / Rp110.000; 40:60 Rp195.000 / Rp105.000; 30:70 Rp190.000 / Rp100.000; 20:80 Rp185.000 / Rp95.000. Harga per kg sebelumnya (Rp210.000 sampai Rp175.000) sudah tidak berlaku. Rasio adalah varian wajib; tidak ada BOLD tanpa rasio |
| **BR-15** | Label **Signature** dan **Reguler** memiliki dua makna berbeda dan tidak boleh dicampur. Pada single origin, keduanya adalah **tier** yang menentukan harga dan wilayah asal serta dipakai sebagai kriteria filter. Pada lini BRIGHT, keduanya adalah **nama varian blend** — Signature Rp280.000 per 1 kg dan Rp150.000 per 0,5 kg; Reguler Rp240.000 per 1 kg dan Rp130.000 per 0,5 kg (sejak 9 September 2026; sebelumnya Rp260.000 dan Rp230.000 per kg) — dan **tidak** ikut dalam filter tier katalog. Antarmuka wajib membedakan keduanya secara visual dan tekstual |
| **BR-16** | Full Robusta berharga **Rp180.000 per 1 kg dan Rp100.000 per 0,5 kg**. **Premis asli aturan ini sudah gugur:** BR-16 ada karena Full Robusta dan BOLD 20:80 dulu berharga sama persis Rp175.000/kg, sehingga keduanya tampil identik di kartu katalog. Sejak 9 September 2026 keduanya berbeda Rp5.000 per kg (BOLD 20:80 Rp185.000). **Aturannya tetap berlaku**, dan alasannya sekarang berdiri sendiri: selisih Rp5.000 per kg terlalu tipis untuk menjelaskan apa pun kepada pembeli kedai, sehingga pembedanya tetap harus datang dari deskripsi komposisi dan catatan rasa — bukan dari harga. Keduanya tidak boleh disajikan seolah pilihan yang setara |
...
| **Varian** | Bentuk konkret yang dibeli beserta harganya. Setiap produk memiliki satu atau lebih varian, dan **harga selalu melekat pada varian, bukan pada produk** | Label varian, satuan (pack, paket, kg, 0,5 kg, atau 100 gr), jumlah dasar, harga | "3 pack" Rp392.000; "60:40 — kemasan 1 kg" Rp205.000 |
...
| **Baris Inquiry** | Satu baris pesanan di dalam Order Inquiry | Hanya **produk (slug), varian, dan jumlah**. Harga satuan dan subtotal baris **tidak disimpan**, melainkan diambil ulang dari katalog setiap kali baris ditampilkan atau dipakai menyusun pesan (Bagian 11.1, NFR-12) | Abmisibil — 3 pack — 1 paket (harga di-resolve saat tampil: Rp392.000) |
...
**Contoh pesan yang dihasilkan** (keranjang berisi Abmisibil 3 pack dan satu kemasan 0,5 kg Houseblend BOLD 60:40 — ukuran kemasan minimum sengaja dipakai supaya contohnya tidak bergantung pada cara sebuah jumlah ≥ 1 kg disusun dari dua ukuran kemasan, yang masih terbuka pada FR-21):
...
**Aturan penulisan jumlah pada pesan.** Satuan ditulis persis seperti yang dipilih pengunjung: `1 pack`, `3 pack`, `1 paket` untuk single origin, dan `0,5 kg`, `1 kg`, `1,5 kg`, `5 kg` untuk houseblend — koma desimal Indonesia, tanpa konversi ke gram, dan tanpa membulatkan 0,5 kg menjadi 1 kg. Contoh baris houseblend minimum: `Jumlah: 0,5 kg x Rp115.000` dengan `Subtotal: Rp115.000` untuk BOLD 60:40 — harga satuan yang ditulis adalah **harga kemasan yang dipesan**, bukan tarif per kilogram yang dikalikan pecahan. Menuliskannya sebagai `Rp205.000/kg` akan membuat harga satuan dikali jumlah tidak sama dengan subtotal, dan pembeli yang memeriksa hitungannya wajar menyimpulkan situsnya salah. Seluruh harga pada pesan diambil dari katalog **pada saat tombol ditekan**, bukan pada saat item dimasukkan ke keranjang (Bagian 11.1).
...
- [ ] Seluruh produk tayang di katalog: **11 halaman produk** — tiga lini houseblend (BOLD, BRIGHT, Full Robusta) dan **delapan** single origin, termasuk Sindoro. **Tidak ada lini kedua** sejak KD-09. Totalnya **41 varian jual**: tujuh biji dengan tiga kemasan, Sindoro dengan dua (tanpa kemasan mini, BR-08), dan sembilan rasio houseblend dengan dua ukuran kemasan. Angka itu ditegakkan `EXPECTED_*` pada `web/src/data/validate.ts` dan salinan ketik-ulang lembar "Product" di `web/scripts/check-cart.mjs`, yang menggagalkan build bila katalog diam-diam bertambah atau berkurang — periksa ke sana bila keduanya berbeda.
- [ ] Setiap harga di situs identik dengan sumber harga yang berlaku — lembar "Product" pada `assets/brand/Kopi from heart.xlsx`, disalurkan lewat spreadsheet owner (FR-53, KD-08) — diverifikasi baris per baris oleh dua orang. `00-brand-brief.md` **bukan lagi** sumber harga.
...
- [ ] Varian 3 pack tidak menyediakan pemilih origin campur di mana pun pada antarmuka; salinan teks 3 pack menampilkan penghematan yang **dihitung** dari harga resmi (sejak 9 September 2026: Signature Rp28.000, Reguler Rp23.000), bukan janji variasi origin (BR-10, BR-11, KD-01). Angka penghematan yang ditemukan tertulis sebagai teks di konten adalah kegagalan, berapa pun nilainya.
...
- [ ] Setiap varian houseblend punya **dua harga tersimpan** — 1 kg dan 0,5 kg — yang identik dengan lembar "Product" (BR-13, BR-14, BR-15, BR-16), diverifikasi baris per baris. **Butir lama yang menuntut harga 0,5 kg tepat setengah harga per kg sudah dicabut**; menjalankannya pada katalog yang benar menghasilkan kegagalan palsu.
- [ ] Kedua batas V-06 terpenuhi untuk setiap varian houseblend: dua kemasan 0,5 kg lebih mahal daripada satu kemasan 1 kg, dan satu kemasan 0,5 kg lebih murah daripada kemasan 1 kg.
- [ ] Harga kemasan mini 100 gr tayang untuk tujuh biji single origin yang memilikinya dan **tidak** tayang untuk Sindoro (BR-08), serta selalu lebih murah daripada kemasan 200 gr biji yang sama.
- [ ] Setiap harga di situs identik dengan lembar "Product" pada `assets/brand/Kopi from heart.xlsx`, bukan dengan angka yang tertulis di dokumen mana pun.
...
**Isi:** FR-01, FR-02, FR-03, FR-07, FR-08, FR-09, FR-10, FR-11, FR-12, FR-16, FR-17, FR-18, FR-19, FR-20, FR-21, FR-22, FR-23, FR-24, FR-25, FR-26, FR-27, FR-28, FR-29, FR-31, FR-35, FR-36, FR-37, FR-38, FR-41, FR-42, FR-43, FR-44, FR-45, FR-46, FR-47, FR-48, FR-49 (kecuali `FAQPage`) — total **37 FR**. Seluruh NFR-01 sampai NFR-16 berlaku sejak Fase 1a. **FR-52 tidak lagi berada di sini: ia dicabut KD-09 pada 9 September 2026.**

> **Catatan BA, 9 September 2026 — angka Fase 1a di dokumen ini belum konsisten, dan itu bukan akibat KD-09.** Daftar di atas ditulis sebelum FR-51 dan FR-53 ada dan tidak pernah dimutakhirkan, sehingga ia menyebut 37 FR tanpa memuat keduanya, sementara rekapitulasi Bagian 7 menghitung 38 (kini 37 setelah FR-52 dicabut). Kedua angka itu karena itu **tidak menghitung isi yang sama**. Perbaikannya menuntut penelusuran seluruh tabel FR terhadap kolom Fase, dan hasilnya berpotensi menggeser angka pada Bagian 7 dan Bagian 12 — jadi ia dikerjakan sebagai revisi tersendiri, bukan diselipkan ke v1.6. Sampai itu selesai, **kolom Fase pada tabel FR Bagian 7 yang berlaku**, bukan kedua rekapitulasi ini.

**Halaman:** Beranda, Katalog, **delapan** halaman detail single origin, halaman Houseblend beserta detail lini, Cerita Kami, Kontak, Keranjang, Lacak Pesanan (FR-51).

**Syarat masuk:** BRD v1.6 disetujui CEO; foto produk minimal satu per produk tersedia atau placeholder disetujui; domain titikasalkopi.id aktif. Jam balas WhatsApp **sudah ditetapkan** lewat keputusan KD-03 (setiap hari 08.00–21.00 WIB), demikian pula aturan 3 pack (KD-01) dan kelipatan 0,5 kg (KD-02), sehingga tidak ada lagi keputusan terbuka yang menahan tanggal rilis.
...
**BA-05 — Target G-08 (rata-rata order ritel Rp210.000) menjadi lebih berat setelah KD-01 dan KD-02, dan angkanya perlu ditinjau ulang bersama CEO.** Dengan harga 1 pack Rp125.000–140.000 dan 3 pack Rp352.000–392.000 (per 9 September 2026), rata-rata Rp210.000 secara aritmetika menjadi lebih mudah dicapai pada order single origin — tetapi kemasan kecil yang baru bergerak ke arah sebaliknya: kemasan mini 100 gr mulai Rp70.000 ikut masuk hitungan order ritel. (Sampai v1.5 kalimat ini menyebut dua lini kemasan kecil; lini Katalog Kopi 100 gram dicabut KD-09, sehingga tekanannya berkurang satu sumber — tetapi tidak hilang.) Angka target G-08 karena itu **tetap perlu ditinjau ulang bersama CEO**, dan alasannya sekarang lebih banyak, bukan lebih sedikit. Dua keputusan tanggal 7 September 2026 menggeser hitungan itu ke arah yang berlawanan. Pertama, **KD-01 menutup paket campur antar-origin**; jalur yang pada v1.0 saya sebut sebagai peluang menaikkan G-08 kini resmi tidak ada, sehingga pencapaian target sepenuhnya bergantung pada seberapa menonjol penghematan bundling ditampilkan (BR-10, FR-11) dan pada kesediaan pembeli mengambil tiga kemasan kopi yang sama. Kedua, **KD-02 memasukkan order houseblend 0,5 kg — mulai Rp95.000 sejak 9 September 2026 — ke dalam campuran order ritel**; setiap order semacam itu menarik rata-rata ke bawah meskipun secara bisnis ia justru kabar baik, karena membuka pintu masuk berbiaya rendah bagi home brewer yang belum berani membeli satu kilogram. Rekomendasi BA: pisahkan pelaporan rata-rata order ritel single origin dari rata-rata order ritel houseblend (sudah dimasukkan ke kolom Segmen pada Bagian 11.4), dan nilai G-08 pada segmen single origin saja. Bila CEO ingin satu angka gabungan, angkanya harus diturunkan — bukan karena kinerja memburuk, melainkan karena definisinya berubah.
...
**BA-07 — Sebagian besar biaya Fase 1 sebenarnya ada pada konten dan foto, bukan pada kode.** Membangun katalog sebelas halaman produk dengan keranjang sisi klien adalah pekerjaan yang terukur. Yang menentukan hasil justru kualitas foto produk (A-03, R-10), kelengkapan atribut origin (A-09), dan keputusan kebijakan (A-02). Bila anggaran atau perhatian harus dipilih, prioritaskan pemotretan produk dan pelengkapan data origin, bukan penambahan fitur.

**BA-08 — Beberapa permintaan pada input bisnis berbiaya lebih besar daripada nilainya untuk katalog seukuran ini.** Filter berfaset (US-02), pencarian (US-04), dan rekomendasi produk terkait (US-05) semuanya adalah pola dari toko daring beratus SKU. Pada sebelas halaman produk yang muat dalam dua kali gulir layar HP, ketiganya menambah kode, state, dan pengujian tanpa memperbaiki penemuan produk secara berarti. Ketiganya tetap dikerjakan, tetapi di Fase 1b, dan sebaiknya ditinjau ulang setelah data GA4 menunjukkan apakah pengunjung benar-benar tersesat di katalog.

**BA-09 — Dua kemenduaan pada katalog perlu diselesaikan sebelum implementasi.** Pertama, label "Signature" dan "Reguler" dipakai untuk dua hal berbeda: tier single origin dan nama varian pada lini BRIGHT (BR-15). Bila filter tier dibangun tanpa menyadari ini, BRIGHT akan muncul pada hasil filter single origin dan membingungkan pembeli. Kedua, Full Robusta dan BOLD 20:80 dulu berharga sama persis Rp175.000/kg (BR-16). **Premis itu sudah gugur sejak 9 September 2026**: Full Robusta Rp180.000/kg dan BOLD 20:80 Rp185.000/kg. Masalahnya tidak ikut hilang — selisih Rp5.000 per kg terlalu tipis untuk menjelaskan apa pun, sehingga tanpa penjelasan pembeda pembeli kedai tetap akan bertanya mana yang lebih baik dan owner kembali menjelaskan manual. Yang berubah hanya ini: pembedanya kini **tidak boleh** dicari dari harga.
...
| OQ-02 | Apakah houseblend hanya dijual per kilogram penuh, atau ada kelipatan 0,5 kg? | BR-13, konfigurator FR-21 | ~~Sebelum Fase 1a~~ | **Tertutup 7 September 2026 — keputusan KD-02: minimum 0,5 kg, kelipatan 0,5 kg.** **Direvisi 9 September 2026 (KD-02 revisi kedua):** bagian "harga 0,5 kg tepat setengah harga per kg" dari penutupan itu **dicabut**. Houseblend dijual dalam dua ukuran kemasan — 1 kg dan 0,5 kg — masing-masing dengan harga tersimpan sendiri, karena kemasan kecil membawa marginnya sendiri. Minimum dan kelipatan 0,5 kg tidak berubah. Diterapkan pada BR-03, BR-13, BR-14, BR-15, BR-16, BR-17, FR-08, FR-21, FR-28, Bagian 11.2, dan kriteria penerimaan Bagian 12 |
...
| **Kelipatan 0,5 kg** | Satuan pemesanan houseblend sejak KD-02: 0,5 / 1 / 1,5 / 2 kg dan seterusnya. **Bukan** aturan harga — sejak KD-02 revisi kedua (9 September 2026), harga 0,5 kg adalah angka tersendiri yang disimpan, bukan setengah harga per kg |
| **Main Pack / Mini Pack** | Nama kolom pada lembar "Product" bisnis plan, dipakai apa adanya sebagai nama dua ukuran kemasan houseblend: Main Pack = 1 kg, Mini Pack = 0,5 kg (BR-13). Keduanya produk yang dijual, bukan satu produk dengan dua cara menghitung |
| **Kemasan mini 100 gr** | Kemasan kecil pada single origin, dari kolom "Single Origin - Mini Packs" lembar "Product" (BR-08), berharga **per tier**. Tujuh dari delapan biji memilikinya; Sindoro tidak. **Ini satu-satunya "100 gram" yang masih ada.** Jangan tertukar dengan **Katalog Kopi 100 gram** (FR-52, KD-07) — lini terpisah berisi biji lain berharga per biji, yang **dicabut KD-09 pada 9 September 2026**. Setiap dokumen yang menyebut "100 gram" wajib menyebut yang mana |

---

## 17. Persetujuan

Dokumen ini berstatus **Draft for Approval**, versi **1.5**. Dengan menyetujui, CEO menyetujui pula pemecahan Fase 1 menjadi 1a dan 1b, penurunan empat butir Must pada Bagian 5.3, seluruh aturan bisnis pada Bagian 9 termasuk BR-19 dan BR-20 yang baru, aturan pemakaian warna pada Bagian 12.1, penarikan FR-49 ke Fase 1a, serta komitmen menjawab sisa keputusan terbuka pada Bagian 16.2 sesuai tenggat masing-masing. Keputusan KD-01, KD-02, dan KD-03 pada `docs/00b-ceo-decisions.md` sudah diserap ke dalam dokumen ini dan tidak dibuka ulang.
